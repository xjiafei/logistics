...
public class DeviceLocationParseBtsTask {

	private Logger log = LoggerFactory.getLogger(DeviceLocationParseBtsTask.class);
...
//		dvcDeviceLocationParseService.executeBts();
		dvcDeviceLocationParseService.excuteGoogleGeolocationByBts();
