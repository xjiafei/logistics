...
public class Gps2Amap {
    ...
    public static LatLng transWGS2GCJ(LatLng wgLoc) {
    ...
    public static LatLng transGCJ2WGS(LatLng wgLoc) {
        //如果在国外，则默认不进行转换
        if (outOfChina(wgLoc.latitude, wgLoc.longitude)) {
                return new LatLng(wgLoc.latitude, wgLoc.longitude);
        }
    ...
    public static void main(String[] s){
    	System.out.println(Gps2Amap.transWGS2GCJ(new LatLng("22.558035,113.97091")));
